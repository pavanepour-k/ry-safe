...
def test_markup_class():
    ...
    try:
        ...
        expected = (
            "<b>Safe</b>&lt;script&gt;alert(&#x27;xss&#x27;)&lt;/script&gt;"
        )
...
def test_performance():
    ...
    try:
        ...
        print(
            f"   ✓ Escaped {len(test_string)} characters in {duration:.4f} seconds"
        )
...
def test_fastapi_integration():
    ...
    try:
        ...
        if hasattr(rysafe, "SafeHTMLResponse"):
            ...
            print(
                "   ⚠️ FastAPI integration not available (FastAPI not installed)"
            )
