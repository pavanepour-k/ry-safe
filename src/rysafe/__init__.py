...
from .markupsafe_compat import Markup, escape, escape_silent, soft_str, soft_unicode

# Try to import FastAPI components, but don't fail if FastAPI is not installed
try:
    from .fastapi_integration import SafeHTMLResponse, AutoEscapeMiddleware, setup_auto_escape
