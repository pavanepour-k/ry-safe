...
class CodePatternComparator:
    ...
    def _is_snake_case(self, name: str) -> bool:
        ...
        return (
            ...
            not name.startswith('_') and  # After stripping leading _
            not name.endswith('_') and
            '__' not in name  # No double underscores in middle
        )
...
class NamingConventionValidator:
    ...
    def suggest_name(name: str, target_case: str) -> str:
        ...
        parts = re.findall(r'[A-Z][a-z]+|[a-z]+|[A-Z]+(?=[A-Z][a-z]|\b)|[0-9]+', name)
